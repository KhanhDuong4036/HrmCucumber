...
public class GlobalConstants {
	...
	public static final String UPLOAD_FOLDER_PATH = PROJECT_PATH + File.separator + "\\src\\main\\resources\\uploadFiles" + File.separator;
	public static final String DOWNLOAD_FOLDER_PATH = PROJECT_PATH + File.separator + "downloadFiles";

	public static final String HRM_DB_URL = "https://opensource-demo.orangehrmlive.com/index.php/auth/login";
